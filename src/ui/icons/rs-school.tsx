...
interface RsSchoolIconProps {
  width: string;
  height: string;
}

export const RsSchoolIcon = (props: RsSchoolIconProps) => (
  <SvgIcon sx={{ width: props.width, height: props.height }}>
    ...
    >
      ...
      />
      <path fill="#fff" d="M482.1 114.4h27.6v67.4h43.1v22H482v-89.4z" />
      <ellipse
