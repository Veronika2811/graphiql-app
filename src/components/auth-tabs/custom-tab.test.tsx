...
describe('CustomTab component', () => {
  it('should renders tabs and switches active tab correctly', () => {
  ...
  it('should does not re-render when props remain the same', () => {
  ...
  it('should renders extra empty tabs when tabContent is smaller than tabNames', () => {
    const tabNames = ['Tab 1', 'Tab 2', 'Tab 3'];
    const tabContent = [
      <div key="1">Content 1</div>,
      <div key="2">Content 2</div>,
  ...
  it('should renders extra empty content when tabNames is smaller than tabContent', () => {
  ...
  it('should does not render when no children are passed', () => {
    const children = null;
