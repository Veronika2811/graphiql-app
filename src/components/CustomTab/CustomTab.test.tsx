...
import { CustomTab, TabPanel, TabPanelMemo } from 'components/CustomTab';
...
describe('CustomTab', () => {
  it('renders tabs and switches active tab correctly', () => {
    ...
    const { getByText } = render(
      <CustomTab tabNames={tabNames} tabContent={tabContent} />
    );
  ...
  it('renders extra empty tabs when tabContent is smaller than tabNames', () => {
    ...
    render(<CustomTab tabNames={tabNames} tabContent={tabContent} />);
