...
describe('SignInForm component', () => {
  ...
  it('should allows user to input data and submit form', async () => {
  ...
  it('should allows user to input data and submit form', async () => {
    ...
    await waitFor(() => {
      ...
      expect(mockOpenSnackbar).toHaveBeenCalled();
      expect(mockOpenSnackbar).toHaveBeenCalledWith(
        englishDictionary.dic_error_api_default,
        'error'
      );
    });
  });

  it('should displays error message for password field when validation fails', async () => {
