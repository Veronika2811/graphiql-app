...
describe('DocsWrapper component', () => {
  it('should renders the title with correct text from translation', () => {
    render(<DocsWrapper />);
  ...
  it('should renders doc information based on Redux state', () => {
  ...
  it('should renders formatted text for special cases', () => {
  ...
  it('should renders opening curly brace if the last character is {', () => {
  ...
  it('should renders closing curly brace', () => {
